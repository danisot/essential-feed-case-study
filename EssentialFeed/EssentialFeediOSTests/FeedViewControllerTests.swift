...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImage() {
        ...
        XCTAssertEqual(view1?.isShowingImageLoadingIndicator, true, "Expected loading indicator state change for second view once first image loading completes successfully")
    ...
    private func makeSUT(file: StaticString = #filePath, line: UInt = #line) -> (sut: FeedViewController, LoaderSpy) {
